...
from FL_Information import FL_Agent
...
from Differential_Evolution import Fitness, DE, selection
np.random.seed(1)
...
BATCH_SIZE = 256
gamma = 0.95
noise = 1e-12  # background noise(Watts)
popsize = 10
epsilon = 0.1
...
def necessary(b_M, agent_1_target, agent_2_target, agent_3_target,
              agent_4_target, agent_5_target, agent_6_target,
              agent_7_target, agent_8_target, agent_9_target,
              agent_10_target):
    f_state = b_M[:, 0:550]
...
def Fineturning(Price, users_set, meta_1, meta_2, meta_3, meta_4, meta_5, meta_6, meta_7, meta_8, meta_9, meta_10):
    agent_1 = meta_1
    agent_1_target = meta_1
    agent_2 = meta_2
    agent_2_target = meta_2
    agent_3 = meta_3
    agent_3_target = agent_3
    agent_4 = meta_4
    agent_4_target = agent_4
    agent_5 = meta_5
    agent_5_target = agent_5
    agent_6 = meta_6
    agent_6_target = agent_6
    agent_7 = meta_7
    agent_7_target = agent_7
    agent_8 = meta_8
    agent_8_target = agent_8
    agent_9 = meta_9
    agent_9_target = agent_9
    agent_10 = meta_10
    agent_10_target = agent_10
    ...
    sess.run(
        [agent_1_actor_target_init, agent_1_critic_target_init, agent_2_actor_target_init,
         agent_2_critic_target_init,
         agent_3_actor_target_init, agent_3_critic_target_init, agent_4_actor_target_init,
         agent_4_critic_target_init,
         agent_5_actor_target_init, agent_5_critic_target_init, agent_6_actor_target_init,
         agent_6_critic_target_init,
         agent_7_actor_target_init, agent_7_critic_target_init, agent_8_actor_target_init,
         agent_8_critic_target_init,
         agent_9_actor_target_init, agent_9_critic_target_init, agent_10_actor_target_init,
    ...
    for eps in range(MAX_EPISODES):
        ...
        upper_eps_rew1, upper_eps_rew2, upper_eps_rew3 = 0, 0, 0
        upper_eps_rew4, upper_eps_rew5, upper_eps_rew6 = 0, 0, 0
        upper_eps_rew7, upper_eps_rew8, upper_eps_rew9, upper_eps_rew10= 0, 0, 0, 0
        for step in range(1, MAX_EP_STEPS + 1, 1):
            ...
            if p >= 0.7:
                if action_f1 + action_f2 + action_f3 + action_f4 + action_f5 + action_f6 + action_f7 + action_f8 + action_f9 + action_f10 <= 5:
                    action_a = [action_f1, action_f2, action_f3, action_f4, action_f5, action_f6, action_f7, action_f8,
                                action_f9, action_f10]
                    char_data1 = char_data1 + 1
                    kk = random.sample(range(0, 10), 7)
                    for i in range(len(kk)):
                        action_a[kk[i]] = 1
                    action_f1, action_f2, action_f3, action_f4, action_f5, action_f6, action_f7, action_f8, action_f9, action_f10 = \
                        action_a[0], action_a[1], action_a[2], action_a[3], action_a[4], action_a[5], action_a[6], \
                        action_a[7], \
                        action_a[8], action_a[9]

            elif p > 0.5 and p < 0.7:
                if action_f1 + action_f2 + action_f3 + action_f4 + action_f5 + action_f6 + action_f7 + action_f8 + action_f9 + action_f10 <= 3 & action_f1 + action_f2 + action_f3 + action_f4 + action_f5 + action_f6 + action_f7 + action_f8 + action_f9 + action_f10 >= 7:
                    action_d = np.zeros(10)
                    jj = random.sample(range(0, 10), 6)
                    for m in range(len(jj)):
                        action_d[jj[m]] = 1
                    action_f1, action_f2, action_f3, action_f4, action_f5, action_f6, action_f7, action_f8, action_f9, action_f10 = \
                        action_d[0], action_d[1], action_d[2], action_d[3], action_d[4], action_d[5], action_d[6], \
                        action_d[7], action_d[8], action_d[9]
            elif p >= 0.4 and p <= 0.5:
                if action_f1 + action_f2 + action_f3 + action_f4 + action_f5 + action_f6 + action_f7 + action_f8 + action_f9 + action_f10 <= 3 & action_f1 + action_f2 + action_f3 + action_f4 + action_f5 + action_f6 + action_f7 + action_f8 + action_f9 + action_f10 >= 7:
                    action_b = np.zeros(10)
                    jj = random.sample(range(0, 10), 4)
                    for m in range(len(jj)):
                        action_b[jj[m]] = 1
                    action_f1, action_f2, action_f3, action_f4, action_f5, action_f6, action_f7, action_f8, action_f9, action_f10 = \
                        action_b[0], action_b[1], action_b[2], action_b[3], action_b[4], action_b[5], action_b[6], \
                        action_b[7], action_b[8], action_b[9]
            elif p < 0.4:
                if action_f1 + action_f2 + action_f3 + action_f4 + action_f5 + action_f6 + action_f7 + action_f8 + action_f9 + action_f10 > 5:
                    action_c = [action_f1, action_f2, action_f3, action_f4, action_f5, action_f6, action_f7, action_f8,
                                action_f9, action_f10]
                    jj = random.sample(range(0, 10), 4)
                    for m in range(len(jj)):
                        action_c[jj[m]] = 0
            ...
            upper_rew1 = Price[0] * (1 - 1 / math.exp((psi * (Datasize[0] * qulity[0]))))
            upper_rew2 = Price[1] * (1 - 1 / math.exp((psi * (Datasize[1] * qulity[1]))))
            upper_rew3 = Price[2] * (1 - 1 / math.exp((psi * (Datasize[2] * qulity[2]))))
            upper_rew4 = Price[3] * (1 - 1 / math.exp((psi * (Datasize[3] * qulity[3]))))
            upper_rew5 = Price[4] * (1 - 1 / math.exp((psi * (Datasize[4] * qulity[4]))))
            upper_rew6 = Price[5] * (1 - 1 / math.exp((psi * (Datasize[5] * qulity[5]))))
            upper_rew7 = Price[6] * (1 - 1 / math.exp((psi * (Datasize[6] * qulity[6]))))
            upper_rew8 = Price[7] * (1 - 1 / math.exp((psi * (Datasize[7] * qulity[7]))))
            upper_rew9 = Price[8] * (1 - 1 / math.exp((psi * (Datasize[8] * qulity[8]))))
            upper_rew10 = Price[9] * (1 - 1 / math.exp((psi * (Datasize[9] * qulity[9]))))

            model_per1 = 1 / math.exp((psi * (Datasize[0] * qulity[0])))
            model_per2 = 1 / math.exp((psi * (Datasize[1] * qulity[1])))
            model_per3 = 1 / math.exp((psi * (Datasize[2] * qulity[2])))
            model_per4 = 1 / math.exp((psi * (Datasize[3] * qulity[3])))
            model_per5 = 1 / math.exp((psi * (Datasize[4] * qulity[4])))
            model_per6 = 1 / math.exp((psi * (Datasize[5] * qulity[5])))
            model_per7 = 1 / math.exp((psi * (Datasize[6] * qulity[6])))
            model_per8 = 1 / math.exp((psi * (Datasize[7] * qulity[7])))
            model_per9 = 1 / math.exp((psi * (Datasize[8] * qulity[8])))
            model_per10 = 1 / math.exp((psi * (Datasize[9] * qulity[9])))
            ...
            rew9_eps += rew9
            rew10_eps += rew10
            upper_eps_rew1 += upper_rew1
            upper_eps_rew2 += upper_rew2
            upper_eps_rew3 += upper_rew3
            upper_eps_rew4 += upper_rew4
            upper_eps_rew5 += upper_rew5
            upper_eps_rew6 += upper_rew6
            upper_eps_rew7 += upper_rew7
            upper_eps_rew8 += upper_rew8
            upper_eps_rew9 += upper_rew9
            upper_eps_rew10 += upper_rew10
            # update
            char_data11 = char_data1
            char_data22 = char_data2
            qulity = char_data33 - char_data22
            ...
            if (eps + 1) >= 2:
                ...
                f8_b_action_next, f9_b_action_next, f10_b_action_next = necessary(b_M, agent_1_target, agent_2_target,
                                                                                  agent_3_target,
                                                                                  agent_4_target, agent_5_target,
                                                                                  agent_6_target,
                                                                                  agent_7_target, agent_8_target,
                                                                                  agent_9_target,
                                                                                  agent_10_target)
                ...
                f_state, f1_b_action, f2_b_action, f3_b_action, f4_b_action, f5_b_action, f6_b_action, f7_b_action, f8_b_action, f9_b_action, f10_b_action, f1_b_reward, f2_b_reward, f3_b_reward, f4_b_reward, f5_b_reward, f6_b_reward, f7_b_reward, f8_b_reward, f9_b_reward, f10_b_reward, b_state_next, f1_b_action_next, f2_b_action_next, f3_b_action_next, f4_b_action_next, f5_b_action_next, f6_b_action_next, f7_b_action_next, f8_b_action_next, f9_b_action_next, f10_b_action_next = necessary(
                    b_M, agent_1_target, agent_2_target, agent_3_target,
                    agent_4_target, agent_5_target, agent_6_target,
                    agent_7_target, agent_8_target, agent_9_target,
                    agent_10_target)
                ...
                target_fl = f2_b_reward.reshape(-1, 1) + gamma * agent_2_target.Q(state=b_state_next,
                ...
                other_action_next = np.concatenate((f1_b_action_next, f2_b_action_next,
                                                    ...
                                                    f7_b_action_next, f8_b_action_next, f9_b_action_next,
                                                    f10_b_action_next), axis=1)
                target_fl = f3_b_reward.reshape(-1, 1) + gamma * agent_3_target.Q(state=b_state_next,
                ...
                other_action_next = np.concatenate((f1_b_action_next, f2_b_action_next,
                                                    ...
                                                    f7_b_action_next, f8_b_action_next, f9_b_action_next,
                                                    f10_b_action_next), axis=1)
                target_fl = f4_b_reward.reshape(-1, 1) + gamma * agent_4_target.Q(state=b_state_next,
                ...
                other_action = np.concatenate((f1_b_action, f2_b_action, f3_b_action, f4_b_action,
                                               f6_b_action, f7_b_action, f8_b_action, f9_b_action, f10_b_action),
                                              axis=1)
                other_action_next = np.concatenate((u1_b_action_next, u2_b_action_next,
                                                    u3_b_action_next, u4_b_action_next, u6_b_action_next,
                                                    u7_b_action_next, u8_b_action_next, u9_b_action_next,
                                                    u10_b_action_next), axis=1)
                target_fl = f5_b_reward.reshape(-1, 1) + gamma * agent_5_target.Q(state=b_state_next,
                ...
                other_action_next = np.concatenate((f1_b_action_next, f2_b_action_next,
                                                    ...
                                                    f7_b_action_next, f8_b_action_next, f9_b_action_next,
                                                    f10_b_action_next), axis=1)
                target_fl = f6_b_reward.reshape(-1, 1) + gamma * agent_6_target.Q(state=b_state_next,
                ...
                other_action_next = np.concatenate((f1_b_action_next, f2_b_action_next,
                                                    ...
                                                    f10_b_action_next), axis=1)
                target_fl = f7_b_reward.reshape(-1, 1) + gamma * agent_7_target.Q(state=b_state_next,
                ...
                other_action_next = np.concatenate((f1_b_action_next, f2_b_action_next,
                                                    ...
                                                    f10_b_action_next), axis=1)
                target_fl = f8_b_reward.reshape(-1, 1) + gamma * agent_8_target.Q(state=b_state_next,
                ...
                other_action_next = np.concatenate((f1_b_action_next, f2_b_action_next,
                                                    ...
                                                    f10_b_action_next), axis=1)
                target_fl = f9_b_reward.reshape(-1, 1) + gamma * agent_9_target.Q(state=b_state_next,
                ...
                target_fl = f10_b_reward.reshape(-1, 1) + gamma * agent_10_target.Q(state=b_state_next,
            ...
            # print('eps:%s, step:%s, r_all:%s, loss_avg:%s, acc_global:%s, start_flag:%s' % (eps, step, (
        ...
        upper_reward.append(upper_eps_rew1 + upper_eps_rew2 + upper_eps_rew3 + upper_eps_rew4 +
                            upper_eps_rew5 + upper_eps_rew6 + upper_eps_rew7 + upper_eps_rew8 +
                            upper_eps_rew9 + upper_eps_rew10)
        print(reward_all)
        print(upper_reward)
        print(accuracy)
        print(loss_avg)
        print((model_per1+model_per2+model_per3+model_per4+model_per5+model_per6+model_per7+model_per8+model_per9+model_per10)/10)
        return reward_all, upper_reward, accuracy

if __name__ == '__main__':
    meta_1.restore('_meta_1_10', sess)
    meta_2.restore('_meta_2_10', sess)
    meta_3.restore('_meta_3_10', sess)
    meta_4.restore('_meta_4_10', sess)
    meta_5.restore('_meta_5_10', sess)
    meta_6.restore('_meta_6_10', sess)
    meta_7.restore('_meta_7_10', sess)
    meta_8.restore('_meta_8_10', sess)
    meta_9.restore('_meta_9_10', sess)
    meta_10.restore('_meta_10_10', sess)
    T_meta = 100
    ...
    # Price = PriceRecord[9]
    lower_reward, upper_cost, accuracy, BF, BI = [], [], [], [], []
    UserSetting = [i for i in range(10)]
    np.random.seed(0)
    Parent = np.random.random(3)+1e-3

    for i in range(len(Parent)):
        Parent_extend = Parent.repeat(10)
        Parent_extend = Parent_extend.reshape(Parent.shape[0], 10)
        Price = Parent_extend[i]
        lower_reward_ep, upper_cost_ep, accuracy_ep = Fineturning(Price, UserSetting, meta_1, meta_2, meta_3, meta_4, meta_5, meta_6, meta_7, meta_8, meta_9, meta_10)
        lower_reward.append(lower_reward_ep)
        upper_cost.append(upper_cost_ep)
        accuracy.append(accuracy_ep)
    ParentF, ParentCV = Fitness(Parent, upper_cost, accuracy)
    lower_reward, upper_cost, accuracy = [], [], []
    BestF_init = np.min(ParentF, axis=0)
    index_init = np.argmin(ParentF, axis=0)
    Bestindi_init = Parent[index_init]
    for t in range(T_meta):
        print('Round:%s'%t)
        Offspring = DE(Parent)
        for j in range(len(Parent)):
            Offspring_extend = Offspring.repeat(10)
            Offspring_extend = Offspring_extend.reshape(Offspring.shape[0], 10)
            Price = Offspring_extend[j]
            lower_reward_ep, upper_cost_ep, accuracy_ep = Fineturning(Price, UserSetting, meta_1, meta_2, meta_3,
                                                                      meta_4, meta_5, meta_6, meta_7, meta_8, meta_9,
                                                                      meta_10)
            lower_reward.append(lower_reward_ep)
            upper_cost.append(upper_cost_ep)
            accuracy.append(accuracy_ep)
        OffspringF, Offspring_CV = Fitness(Offspring, upper_cost, accuracy)
        Parent, ParentF, BestF, Bestindi = selection(ParentF, OffspringF, Parent, Offspring)
        lower_reward, upper_cost, accuracy = [], [], []
        BF.append(BestF)
        BI.append(Bestindi)
    BestF_final = np.min(BF, axis=0)
    index_final = np.argmin(BF, axis=0)
    Bestindi_final = BI[index_final]
    print(BF)
    print(Bestindi)
    print(BestF_final,Bestindi_final)

    fig, ax = plt.subplots(figsize=(8, 6))
    #    rolling_intv = 20

    plt.plot(np.arange(len(BF)) + 1, np.array(BF), 'b')
